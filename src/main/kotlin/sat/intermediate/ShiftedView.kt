...
import sat.general.AbstractView
...
open class ShiftedView(
     ...
     */
    private val innerVariables = mutableMapOf<sat.constructor.Variable, Variable>()

    /**
     * Maps each inner variable instance
     * to it's outer analogue
     */
    private val outerVariables = mutableMapOf<Variable, sat.constructor.Variable>()

    /**
     * A handy alias
     */
    protected fun sat.constructor.Variable.toInner(): Variable {
     ...
     * A handy alias
     */
    protected fun Variable.toOuter(): sat.constructor.Variable {
     ...
     * inner analogue
     */
    protected fun sat.constructor.Literal.toInner(): Literal {
     ...
     * outer analogue
     */
    protected fun Literal.toOuter(): sat.constructor.Literal {
